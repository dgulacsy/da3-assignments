...
Without defining a loss function we checked whether our best models were appropriately callibrated using callibration curves, that you can take a look at below.
...
Next, we ran a cross validation on choosing the loss function with the minimal expected loss. The results can be seen in this table. 
