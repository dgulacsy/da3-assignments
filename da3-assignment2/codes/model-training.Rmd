...
top_models<-models[names(cv_aucs[1:3])]
...
for (model_name in names(top_models)) {
  ...
  # for fold #5
  cv_rocs[[model_name]] <- roc_obj
  cv_threshold[[model_name]] <- best_treshold
  cv_expected_loss[[model_name]] <- expected_loss_cv[[fold]]
